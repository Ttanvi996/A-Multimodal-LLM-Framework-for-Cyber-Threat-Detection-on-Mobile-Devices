...
Threat Detection Layer (ML Models)

Risk Reporting Layer (LLM)

Each modality has its own preprocessing pipeline and threat classifier.

Datasets Used
1)CICIDS2017 — Network Intrusion Detection
...
2)Phishing & Malicious URL Dataset
...
3)Malimg Dataset — Malware Image Classification
